// Container demux and audio decode for the Jellyfin Starfish player. The app links and
// ships one known FFmpeg build rather than trying to impersonate each TV's FFmpeg ABI.
#include <errno.h>
#include <limits.h>
#include <stdint.h>
#include <stdlib.h>
...
struct jf_demux {
    ...
    AVPacket *packet;
    // Starfish consumes decoded audio as interleaved stereo S16LE PCM.
...
/// matching the PCM format advertised to Starfish.
